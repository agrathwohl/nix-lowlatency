...
#############################################
  ...
  environment.shellAliases = {
    ytdl = "yt-dlp -N 10 --yes-playlist --download-archive 'archive.log' -i
    --embed-thumbnail --embed-subs --embed-metadata --embed-chapters --write-subs --write-auto-subs -f best --merge-output-format mkv";
  };
